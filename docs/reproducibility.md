...
```bash
python scripts/run_revision_experiments.py --awa2_zip data/raw/awa2.zip --xlsa17_zip data/raw/xlsa17.zip --out . --seed 42 --local_sample_size 1000
```
...
- Re-run `python scripts/audit_revision_package.py` before release.
