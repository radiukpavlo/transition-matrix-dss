...
- PDF: `manuscript\figs_archived\fig25_a_revision_pipeline.pdf`
...
- PDF: `manuscript\figs_archived\fig25_b_artifact_counts.pdf`
...
- PDF: `manuscript\figs_archived\fig25_c_claim_gates.pdf`
...
- PDF: `manuscript\figs_archived\fig25_d_validation_completeness.pdf`
...
- PDF: `manuscript\figs_archived\fig26_a_object_level_audit_outcomes.pdf`
...
- PDF: `manuscript\figs_archived\fig26_b_conflict_abstention_limits.pdf`
...
- PDF: `manuscript\figs_archived\fig26_c_object_level_bootstrap_intervals.pdf`
...
- PDF: `manuscript\figs_archived\fig27_a_coverage_by_discretizer.pdf`
...
- Core conclusion: Discretizer comparisons quantify WEDD without claiming universal superiority.
- Source data: `outputs/revision_v1/awa2/awa2_discretizer_comparison_summary.csv`
- PDF: `manuscript\figs_archived\fig27_b_accuracy_by_discretizer.pdf`
...
- Core conclusion: Discretizer comparisons quantify WEDD without claiming universal superiority.
- Source data: `outputs/revision_v1/awa2/awa2_discretizer_comparison_summary.csv`
- PDF: `manuscript\figs_archived\fig27_c_fidelity_by_discretizer.pdf`
...
- Core conclusion: Discretizer comparisons quantify WEDD without claiming universal superiority.
- Source data: `outputs/revision_v1/awa2/awa2_discretizer_comparison_summary.csv`
- PDF: `manuscript\figs_archived\fig27_d_conflict_by_discretizer.pdf`
...
- PDF: `manuscript\figs_archived\fig27_e_paired_wedd_mdlp_intervals.pdf`
...
- PDF: `manuscript\figs_archived\fig28_a_q_sensitivity.pdf`
...
- PDF: `manuscript\figs_archived\fig28_b_svd_rank_sensitivity.pdf`
...
- PDF: `manuscript\figs_archived\fig28_c_confidence_threshold_frontier.pdf`
...
- PDF: `manuscript\figs_archived\fig28_d_runtime_summary.pdf`
...
- PDF: `manuscript\figs_archived\fig29_a_protocol_b_seed_metrics.pdf`
...
- Source data: `outputs/revision_v1/awa2/awa2_protocol_b_seedwise.csv`
- PDF: `manuscript\figs_archived\fig29_b_transfer_accuracy_vs_mae.pdf`
...
- PDF: `manuscript\figs_archived\fig29_c_per_class_protocol_b_failures.pdf`
...
- PDF: `manuscript\figs_archived\fig30_a_synthetic_macro_f1.pdf`
...
- Core conclusion: Synthetic controls show recoverability and noise degradation within a bounded setting.
- Source data: `outputs/revision_v1/synthetic/synthetic_summary_by_noise.csv`
- PDF: `manuscript\figs_archived\fig30_b_synthetic_rule_recovery.pdf`
...
- Core conclusion: Synthetic controls show recoverability and noise degradation within a bounded setting.
- Source data: `outputs/revision_v1/synthetic/synthetic_summary_by_noise.csv`
- PDF: `manuscript\figs_archived\fig30_c_synthetic_coverage.pdf`
...
- Core conclusion: Synthetic controls show recoverability and noise degradation within a bounded setting.
- Source data: `outputs/revision_v1/synthetic/synthetic_summary_by_noise.csv`
- PDF: `manuscript\figs_archived\fig30_d_synthetic_threshold_error.pdf`
...
- PDF: `manuscript\figs_archived\fig31_a_portability_coverage_fidelity.pdf`
...
- Source data: `outputs/revision_v1/statistics/cross_domain_generalization.csv`
- PDF: `manuscript\figs_archived\fig31_b_transition_mae_by_scope.pdf`
...
- Source data: `outputs/revision_v3/statistics/object_level_metric_summary.csv`
- PDF: `manuscript\figs_archived\fig31_c_cross_domain_object_metrics.pdf`
...
- PDF: `manuscript\figs_archived\fig32_a_sun_category_histograms.pdf`
...
- Source data: `outputs/revision_v3/sun/sun_category_diagnostics_v3.csv`
- PDF: `manuscript\figs_archived\fig32_b_sun_coverage_conflict_map.pdf`
...
- Source data: `outputs/revision_v3/sun/sun_category_diagnostics_v3.csv`
- PDF: `manuscript\figs_archived\fig32_c_sun_best_covered_categories.pdf`
...
- PDF: `manuscript\figs_archived\fig33_a_derm7pt_diagnosis_diagnostics.pdf`
...
- PDF: `manuscript\figs_archived\fig33_b_derm7pt_encoder_manifest.pdf`
...
- PDF: `manuscript\figs_archived\fig33_c_derm7pt_concept_diagnostics.pdf`
...
- PDF: `manuscript\figs_archived\fig34_a_artifact_hash_families.pdf`
...
- PDF: `manuscript\figs_archived\fig34_b_manuscript_claim_checks.pdf`
...
- PDF: `manuscript\figs_archived\fig34_c_v3_qc_checklist.pdf`
...
- PDF: `manuscript\figs_archived\fig34_d_submission_bundle_gates.pdf`
